...
final readonly class FindCustomerByUuidOrIdQuery implements QueryInterface
{
    /**
     * @throws Exception
     */
    public function __construct(
        ...
        if (null === $this->uuid && null === $this->id) {
            throw new Exception('unable to find customer by uuid or id without uuid and id.');
        }
    }
}
