...
final readonly class FindChildreByNuseryStructueQueryHander implements QueryHandlerInterface
{
     ...
     */
    public function __invoke(FindChildreByNuseryStructueQuery $query): ?array
    {
